...
export function WelcomeModal({ ...props }: WelcomeModalProps) {
  ...
  return (
    ...
    >
      <ModalOverlay />
      <ModalContent>
        <ModalBody position="relative" w="full" maxW="full" p="0">
          <Box display="block" pt="46.11%" pointerEvents="none" />
          ...
          <Flex
            ...
            overflow="hidden"
          >
            <Flex position="relative" flex="1" flexDirection="column" maxW="440px" h="full">
              <Flex w="full" maxW="full" alignItems="center" justifyContent="space-between">
              ...
              >
                ...
                <Typography as="p" fontSize="md" lineHeight="6" fontWeight="normal" mt="2">
                  {tab.text}
                </Typography>
              </Flex>
            ...
            >
              <Box display="block" pt="80.93%" pointerEvents="none" />
              <Image
                className="image"
                src={tab.image}
                alt={tab.title}
