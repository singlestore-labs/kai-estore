  ...
  return (
    <Portal>
      <Box
        ...
        {...props}
      >
        <Flex alignItems="center" px="4" py="3" borderBottom="1px" borderColor="s2.gray.700">
          <Logo variant={"s2.small.24"} mr="2" />
          <Typography as="h4" fontSize="md" lineHeight="6" fontWeight="semibold">
            SingleStore
          </Typography>
        </Flex>
        ...
        <Box p="6">
          ...
          <Flex flexDirection="column" rowGap="1" mt="1">
            <Typography as="h6" fontSize="sm" lineHeight="5" fontWeight="semibold" textAlign="center">
              {state.title}
            </Typography>
          </Flex>
        </Box>
