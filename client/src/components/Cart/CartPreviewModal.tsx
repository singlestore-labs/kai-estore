  ...
  return (
    <Modal
      ...
      header={
        ...
        >
          Added to Cart
          <Icon display="inline-block" name="solid.faCheckCircle" w="6" ml="2.5" />
        </Typography>
      }
      footer={
        <Button variant="solid" size="s2.md" onClick={onCheckoutClick}>
          Checkout
        </Button>
      }
    ...
    >
      <ProductList variant="3" products={cartProducts} maxH="467px" />
    </Modal>
  );
}
