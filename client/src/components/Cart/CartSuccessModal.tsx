  ...
  return (
    <Modal size="s2.md" {...props} onClose={onClose}>
      ...
      >
        ...
        <Typography as="p" fontSize="md" lineHeight="6" fontWeight="normal" mt="3">
          Return to Catalog to view new recommendations based on your purchase or test sample queries.
        </Typography>

        <Flex alignItems="center" justifyContent="center" flexWrap="wrap" mt="6" gap="3">
          <Button variant="solid.secondary" size="s2.md" borderRadius="full" onClick={onClose}>
            Return to Catalog
          </Button>

          <Link href={ROUTES.analytics} chakra={{ variant: "solid", size: "s2.md" }}>
            Explore Analytics
          </Link>
        </Flex>
      </Flex>
