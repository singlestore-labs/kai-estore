  ...
  return (
    <Page mainProps={{ color: "white", bg: "s2.gray.900" }}>
      <Section
        ...
        mt="6"
      >
        <Section variant="3" title="Connect to SingleStoreDB">
          {!isInitialValuesLoading && (
            ...
            >
              ...
              <Box>
                ...
                />
                <Box display="flex" alignItems="center" justifyContent="flex-end" gap="3" mt="8">
      ...
      <ConnectLoader {...loaderSate} variant="dark" />
    </Page>
  );
}
